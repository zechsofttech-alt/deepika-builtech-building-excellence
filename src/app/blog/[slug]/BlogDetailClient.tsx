...
const BlogDetailClient = ({ post }: { post: any }) => {
    ...
    <div className="min-h-screen bg-white">
      ...
      <section className="pt-40 pb-20 bg-surface-subtle border-b border-surface-mid">
        <div className="container mx-auto px-6 lg:px-12">
          ...
          <Link href="/blogs" className="inline-flex items-center gap-2 text-ink-muted hover:text-amber mb-12 transition-colors group focus-visible:outline focus-visible:outline-2 focus-visible:outline-amber p-1">
                ...
                <div className="border border-surface-mid p-10 rounded-[2.5rem]">
                  ...
                  <div className="space-y-8">
                    {blogPosts.filter(p => p.slug !== post.slug).slice(0, 3).map(p => (
                      <Link key={p.slug} href={`/blog/${p.slug}`} className="group block focus-visible:outline focus-visible:outline-2 focus-visible:outline-amber rounded-sm p-1">
