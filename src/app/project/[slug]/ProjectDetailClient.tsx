          ...
          <div className="grid lg:grid-cols-3 gap-20">
            ...
            <div className="lg:col-span-1">
              <div className="bg-carbon p-10 rounded-[2.5rem] sticky top-32">
                ...
                <Link href="/contact" className="mt-12 block w-full bg-amber text-carbon text-center font-black py-4 rounded-xl hover:bg-white transition-all shadow-xl shadow-amber/10">
