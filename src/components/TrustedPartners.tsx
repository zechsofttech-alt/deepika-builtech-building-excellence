  ...
  return (
    <section className="bg-white py-6 md:py-14 overflow-hidden relative">
      <div className="container mx-auto px-6 mb-4 md:mb-10">
        <p className="text-center text-xs font-bold tracking-[0.2em] text-ink-muted uppercase">
        ...
        <div className="flex w-max animate-marquee items-center py-2">
          {marqueePartners.map((partner, index) => {
            ...
            return (
              <div
                key={index}
                className="flex items-center gap-3 w-48 mx-8 text-ink-muted hover:text-amber transition-all duration-500 hover:scale-105 group"
              >
